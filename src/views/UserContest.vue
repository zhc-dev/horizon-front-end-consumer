<template>
    <div class="my-exam-page">
      <div class="exam-list-block">
        ...
        <div class="exam-list-content" v-for="(contest, index) in userContestList" :key="index">
          ...
          <div>
            <div class="exam-end-lable-list" v-if="isHistoryContest(contest)">
              ...
              <el-button class="exam-rank-lable" type="text" @click="togglePopover(contest.examId)">查看排名</el-button>
              <el-button class="exam-rank-lable" type="text" @click="goHistoryContest(contest)">竞赛练习</el-button>
            </div>
            <div class="exam-status-lable exam-end-lable-list" v-else-if="isNotStart(contest)">未开赛</div>
            <div class="exam-end-lable-list" v-else>
              <el-button class="exam-rank-lable" type="text" plain @click="goContest(contest)">开始答题</el-button>
            </div>
          </div>
        </div>
  ...
  import {
    getUserContestListService,
  } from "@/apis/contest"
  import router from '@/router'
  
  const userContestList = ref([]) //消息列表
  ...
  //消息列表
  async function getUserContestList() {
    const ref = await getUserContestListService(params.value)
    userContestList.value = ref.rows
