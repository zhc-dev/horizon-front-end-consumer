    ...
    <div class="login-page">
        ...
        <div class="login-box">
            <div class="logo-box">
                ...
                <div>
                    <div class="sys-name">horizon</div>
            ...
            <div class="form-box">
                <div class="form-item">
                    ...
                    <el-input v-model="emailForm.email" type="text" placeholder="请输入邮箱账号" />
                </div>
                <div class="form-item">
                    <img src="@/assets/images/yanzhengma.png">
                    <el-input style="width:134px" v-model="emailForm.code" type="text" placeholder="请输入验证码" />
...
const getCode = async () => {
    ...
    const response = await sendCodeService(emailForm)
...
const login = async () => {
    const response = await codeLoginService(emailForm)
